...
function Form() {
  ...
  const validate = (values) => {
    ...
    if (!values.email) {
      ...
      !/^(?=.{5,50}$)[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(values.email)
    ) {
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="col text-center">
                ...
                {formik.errors.file ? (
                  ...
                  <div className="text-success">{formik.values.file}</div>
                )}
              </div>

              <div className="col pb-1">
                <label className="pb-2 mt-3" htmlFor="Name">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div className="col py-2">
                <label className="pb-2 mt-3" htmlFor="email">
                  Email
                </label>
                <input
                  type="text"
              ...
              <div className="col py-2">
                <label className="pb-2 mt-3" htmlFor="phone">
                  PhoneNo
                </label>
                <input
                  type="text"
              ...
              <div className="col py-2">
                <label className="pb-2 mt-3" htmlFor="password">
                  Password
                </label>
                <input
                  type="password"
                ...
                {formik.touched.password && formik.errors.password ? (
                  <div className="password text-danger">
              ...
              <div className="col py-2">
                <label className="pb-2 mt-3" htmlFor="confirmPassword">
                  Confirm Password
                </label>
                <input
                  type="password"
